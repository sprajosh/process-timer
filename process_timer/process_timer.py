...
# Timeout
############################################################
# Derived from https://github.com/pnpnpn/timeout-decorator to make it work in processes
# are not allowed to spawn it's child processes. Ex: celery tasks
...
def timeout(seconds=None, use_signals=True, timeout_exception=TimeoutError, exception_message=None):
    ...
    :param timeout_exception: Exception to throw when a timeout occurs
